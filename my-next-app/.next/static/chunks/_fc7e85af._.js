        ...
        "HotelCardList.useEffect": ()=>{
            const loadHotels = {
                "HotelCardList.useEffect.loadHotels": async ()=>{
                    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hotel$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchHotels"])(destination, selectedFilter, filters?.minPrice, filters?.maxPrice, filters?.selectedStars || [], filters?.selectedInclusions || []);
                    setHotels(data);
                    setLoading(false);
                }
...
//# sourceMappingURL=_fc7e85af._.js.map